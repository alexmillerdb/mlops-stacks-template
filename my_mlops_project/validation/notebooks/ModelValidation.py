...
# * custom_metrics_loader_function          - Specifies the name of the function in my-mlops-project/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in my-mlops-project/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-my-mlops-project-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.default.my-mlops-project-model", "Full (Three-Level) Model Name")
